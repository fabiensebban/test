...
<?php foreach ($aCollections as $aCollection) : ?>
        <tr>
            <td>
                <a href="index.php?page=ouvrage.php&id=<?php echo $aCollection['id']; ?>&tokken=<?php echo $_SESSION['tokken'];?>">
            ...
            <td class="action">
                <a href="suppression_collection.php?id=<?php echo $aCollection['id']; ?>&tokken=<?php echo $_SESSION['tokken'];?>">
                    supprimer
                </a>
            </td>
        </tr>
